      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-10">
        <div className="grid grid-cols-12 gap-8 md:gap-10 mb-10 md:mb-14">
          <FadeUp className="col-span-12 md:col-span-5">
            ...
            <h2 className="font-display font-medium text-4xl sm:text-5xl md:text-6xl leading-[1.02] tracking-[-0.025em]">
              Honoured by peers <span className="text-lime italic font-light">&amp;</span> juries.
            </h2>
          </FadeUp>
          <FadeUp delay={0.1} className="col-span-12 md:col-span-7 md:pl-10 text-white/65 text-sm md:text-base md:flex md:items-end">
            <p>Awards are nice. Sources who keep calling back are nicer. Here&apos;s a bit of both.</p>
          </FadeUp>
        </div>
